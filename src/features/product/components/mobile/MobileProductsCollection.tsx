// src/features/product/components/mobile/MobileProductPageContent.tsx - VERSION THÈMES CORRIGÉS
'use client';
...
export default function MobileProductPageContent({ productId, product }: MobileProductPageContentProps) {
  ...
  return (
    <div className="min-h-screen bg-theme-primary">
        ...
        <section className="py-6 -mt-8 relative z-10">
          <div className="px-6">
            <div className="grid grid-cols-3 gap-4">
              <motion.div 
                className="bg-theme-card backdrop-blur-sm rounded-xl p-4 text-center border border-theme hover:bg-theme-secondary/10 transition-colors shadow-sm"
              ...
              >
                ...
                <span className="text-theme-primary text-xs">Satisfaction</span>
              </motion.div>
              ...
              >
                ...
                <span className="text-theme-secondary text-xs">Ventes</span>
              </motion.div>
              ...
              >
                ...
                <span className="text-theme-secondary text-xs">Avis</span>
              </motion.div>
            </div>
      ...
      {/* Chat Fullscreen */}
      {isChatFullscreen && (
        <div className="fixed inset-0 bg-theme-primary z-[100]">
          <MobileChatContainer
            product={product}
