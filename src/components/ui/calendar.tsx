    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 dark:bg-transparent"
        ),
        ...
        day_selected:
          "bg-brand-blue text-white hover:bg-brand-blue hover:text-white focus:bg-brand-blue focus:text-white dark:bg-brand-blue dark:text-white dark:hover:bg-brand-blue dark:hover:text-white dark:focus:bg-brand-blue dark:focus:text-white",
