...
export type ConversationStep = 
  ...
  | 'knowledge_base_redirect'
  | 'knowledge_base_fallback'
  | 'knowledge_base_intent'
  | 'knowledge_base_category'
  | 'knowledge_base_product'
  | 'knowledge_base_product_info'
  | 'knowledge_base_product_details'
  | 'knowledge_base_product_usage'
  | 'knowledge_base_product_benefits'
  | 'knowledge_base_product_rules'
  | 'knowledge_base_product_target_audience'
  | 'knowledge_base_product_testimonials'
  | 'knowledge_base_product_delivery'
  | 'knowledge_base_product_price'
  | 'knowledge_base_product_questions'
  | 'knowledge_base_product_engagement'
  | 'knowledge_base_product_selection'
  | 'knowledge_base_product_recommendations'
  | 'knowledge_base_product_social_proof'
  | 'knowledge_base_product_objections'
  | 'knowledge_base_product_support'
  | 'knowledge_base_product_conversation'
  | 'knowledge_base_product_finalization'
  | 'knowledge_base_product_cart_management'
  | 'knowledge_base_product_notes'
  | 'knowledge_base_product_account_creation'
  | 'closing_attempt'
  | 'sales_response_generated'
  | 'benefits_social_proof'
  | 'game_rules_compelling'
  | 'delivery_info_compelling'
  | 'high_intent_detected'
  | 'medium_intent_detected'
